...
def PlotHeatmaps(joints, num_keypoints):
    #heatmaps = GenerateHeatmapsFromKeypoints([256, 256], joints, num_keypoints)
    heatmaps = generate_target(joints, num_keypoints)
    return heatmaps
...
def generate_target(joints, num_keypoints):
        '''
