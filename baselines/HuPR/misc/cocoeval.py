    ...
    def computeOks(self, imgId, catId, idx_keypoint=-1):
        ...
        for j, gt in enumerate(gts):
            ...
            for i, dt in enumerate(dts):
                ...
                assert len(d) == 42, f'keypoints should be 14x3 (frame {imgId}, category {catId}, detection {i})'
                xd = d[0::3]; yd = d[1::3]
                if k1>0:
        ...
        for k, k0 in enumerate(k_list):
            ...
            for a, a0 in enumerate(a_list):
                ...
                for m, maxDet in enumerate(m_list):
                    E = [self.evalImgs[Nk + Na + i] for i in i_list]# if self.ious[(_pe.imgIds[i], p.catIds[k0])]]
...
class Params:
    ...
    def setKpParams(self):
        ...
        self.useCats = 1
        # R_Hip, R_Knee, R_Ankle, L_Hip, L_Knee, L_Ankle, Neck, Head, L_Shoulder, L_Elbow, L_Wrist, R_Shoulder, R_Elbow, R_Wrist
